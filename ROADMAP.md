...
| V030-04 differential parity | In progress | Shared fixtures for movement, core rules, Shield (8), Phase Shift (6), Last Stand (5), and remaining powers (9: Slow-Mo/Boost/Magnet/Bait/Gluttony/Detach); unit contracts remain | Delta reduction and permanent regression corpus compaction |
