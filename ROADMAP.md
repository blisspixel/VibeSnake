...
| V030-03 pure C# slice | In progress | Core rules plus complete Shield, Phase Shift, and Last Stand contracts (body-overlap occupancy, held revive, recovery immunity, documented collision precedence), snapshots, restore, replay integrity, and live Godot recorder | Remaining six powers and migration extraction beyond the recovery matrix |
| V030-04 differential parity | In progress | Shared fixtures for movement, core rules, Shield (8), Phase Shift (6), and Last Stand (5); first-divergence bundles | Remaining six powers and delta reduction beyond first failing prefix |
...
| V030-07 decision close | In progress | 193 native contracts pass with coverage floors; formatting, editor smoke, logical input and lifecycle smoke, finite fallback-audio and Shield feedback smoke, replay recording, isolated atomic storage, strict import, hosted multi-platform player smoke, and artifact inspection exist | Frame and rules throughput, startup, physical input, audio-device, complexity measurements, and final gate review |
...
| V030-12 migration and rollback | In progress | [MIGRATION_MAP.md](docs/engineering/MIGRATION_MAP.md) assigns Python owners to C# or Godot targets, locks port order, and defines rollback and dual-runtime freeze rules | Expand with data-migration procedures and feature-freeze sign-off at 0.3 close |
