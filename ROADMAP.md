...
| AA-03 | Legible agent character | In progress | AA-02 | Passport color plus shed and station labels, Style Contract, public intent, action result, and rival score are visible; next add closed-catalog passport validation, passport-owned avatar rendering, multi-metric style distinction, and observed risk/resources |
...
| AA-09a | Live spectator polish | Runs with AA-03 through AA-08 | AA-02 | Live waiting states; readable observed risk and recovery cues; mute, reduced-motion, high-contrast, and 150-percent-text evidence |
| AA-09b | Recorded spectator story | Queued | AA-06, AA-09a | Typed highlights; deterministic turning-point selection; recorded-first broadcast pacing and montage bound to the exhibition receipt |
| AA-10 | Supported desktop packaging | Queued | AA-01 through AA-09b | Self-contained Windows, macOS, and Linux host packages; viewer artifact qualification; exact manifests, checksums, SBOM, provenance, signing, install, update, rollback, and removal guidance |
...
AA-04 starts before curriculum qualification because hundreds of one-step tool calls are a poor default learning interface. AA-05 and AA-06 may proceed in parallel once their listed dependencies are satisfied. AA-07 waits for a durable exhibition identity instead of trying to infer history from two unrelated ordinary replay files. AA-08 waits for learning and identity contracts because qualification without stable divisions or policy identity would create misleading standings. AA-09a can improve live presentation continuously from AA-02, while AA-09b waits for the AA-06 receipt before building recorded history and turning-point stories. AA-10 waits for the experience and storage surfaces to stabilize because signed packages should not churn around unsettled public contracts. AA-11 and AA-12 cannot redefine the symbolic-step division or share its results silently.
