...
| V030-03 pure C# slice | In progress | Core rules plus Shield, Phase Shift, Last Stand, Slow-Mo, Boost, and Magnet; snapshots, restore, replay integrity, live Godot recorder | Remaining three powers (Bait, Gluttony, Segment Detach) |
| V030-04 differential parity | In progress | Shared fixtures for movement, core rules, Shield (8), Phase Shift (6), and Last Stand (5); tempo powers covered by native unit contracts | Remaining four powers and delta reduction beyond first failing prefix |
