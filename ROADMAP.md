...
| Automation | 466 Python tests pass with 3 expected optional-radio skips on Python 3.11 through 3.14 in hosted CI; 207 native xUnit contracts pass with coverage floors; shared movement, core-rule, Shield, Phase Shift, and Last Stand fixtures pass; Godot headless and packaged-player smoke pass on hosted Windows, macOS, and Linux runners |
...
| V030-03 pure C# slice | In progress | Core rules plus all nine powers; snapshots, restore, replay integrity, live Godot recorder; pure `RulesCadenceClock` for presentation tempo | Remaining pack-boundary and measurement work outside the rules kernel |
...
| V030-07 decision close | In progress | 207 native contracts pass with coverage floors; formatting, editor smoke, logical input and lifecycle smoke, finite fallback-audio and full-portfolio power feedback smoke, cadence-drain contracts, replay recording, isolated atomic storage, strict import, hosted multi-platform player smoke, and artifact inspection exist | Frame and rules throughput, startup, physical input, audio-device, complexity measurements, and final gate review |
