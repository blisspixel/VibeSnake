...
| V030-03 pure C# slice | In progress | Core rules plus all nine powers; snapshots, restore, replay integrity, live Godot recorder | Godot presentation for every power; shell cadence honor for Slow-Mo/Boost |
| V030-04 differential parity | In progress | Shared fixtures for movement, core rules, Shield (8), Phase Shift (6), and Last Stand (5); remaining powers covered by native unit contracts | Shared fixtures for Bait/Gluttony/Detach/tempo/Magnet and delta reduction |
...
| V030-07 decision close | In progress | 203 native contracts pass with coverage floors; formatting, editor smoke, logical input and lifecycle smoke, finite fallback-audio and Shield feedback smoke, replay recording, isolated atomic storage, strict import, hosted multi-platform player smoke, and artifact inspection exist | Frame and rules throughput, startup, physical input, audio-device, complexity measurements, and final gate review |
