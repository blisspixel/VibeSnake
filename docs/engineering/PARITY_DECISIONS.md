...
Shared fixtures declare `vibesnake-core@4` and state their exact injected-or-normalized randomness policy. The four achievement-candidate, five Last Stand, six Phase Shift, eight Shield, nine Remaining Powers, 35 Core Rules, and 100 Movement vectors retain their reviewed Python origins; native tooling reproduces their exact 2,682, 3,596, 3,534, 4,489, 9,548, 57,031, and 999,087 bytes without executing C# rules. Movement ports only the frozen Python movement coordinator and integer-seeded MT19937 command stream under a separate 1,000,000-byte lifecycle. The separate parity tests remain the live behavior consumers. A semantic fixture change requires the relevant parity entry and a reviewed rules decision.
