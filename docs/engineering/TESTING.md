...
- 990 native C# contract tests pass on .NET 10 with 90 percent line and 85 percent branch floors per measured module under Coverlet 10. The current local Windows report measures Rules at 95.77/88.43 percent line/branch, Persistence at 93.55/87.12 percent, creator validation at 95.98/94.00 percent, AgentHost at 93.86/85.81 percent, AgentPlay at 95.77/89.10 percent, AgentViewer at 95.69/95.55 percent, and aggregate native coverage at 94.51/87.80 percent. The gate rejects a coverage report that omits Rules, Persistence, AgentPlay, AgentViewer, or AgentHost, while Coverlet's minimum-module threshold gates every instrumented module; `scripts/test_native.ps1` refreshes the exact report after each run. The 0.4 acceptance target remains 90 percent branch coverage.
