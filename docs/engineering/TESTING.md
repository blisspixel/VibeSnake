...
- 373 native C# contract tests pass on .NET 10 with an 80 percent line floor. Recent local coverage measured about 90 percent line and 82 percent branch across Rules and Persistence combined; exact figures are produced by `scripts/test_native.ps1` coverlet output and may vary slightly by module mix.
