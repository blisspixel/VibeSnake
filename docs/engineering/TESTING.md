...
- 985 native C# contract tests pass on .NET 10 with 90 percent line and 85 percent branch floors per measured module under Coverlet 10. Rules measures 95.77/88.43 percent line/branch, Persistence measures 93.55/87.12 percent, creator validation measures 95.98/94.00 percent, AgentHost measures 94.76/85.81 percent, AgentPlay measures 96.40/88.21 percent, AgentViewer measures 95.69/96.66 percent, and aggregate native coverage is 94.58/87.76 percent. The gate rejects a coverage report that omits Rules, Persistence, AgentPlay, AgentViewer, or AgentHost, while Coverlet's minimum-module threshold gates every instrumented module; `scripts/test_native.ps1` refreshes the exact report after each run. The 0.4 acceptance target remains 90 percent branch coverage.
