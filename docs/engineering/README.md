...
- [Architecture](ARCHITECTURE.md): system boundaries, runtime flow, and current debt.
- [Repository map](REPOSITORY_MAP.md): directory ownership and important files.
- [Code quality standards](CODE_QUALITY_STANDARDS.md): mandatory implementation, security, performance, and evidence rules.
