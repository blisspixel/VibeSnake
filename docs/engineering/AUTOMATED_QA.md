...
- Nine hundred eighty-five native xUnit contracts with 90 percent line and 85 percent branch floors per measured module under Coverlet 10. The latest completed three-platform hosted coverage is 95.77/88.43 percent Rules line/branch, 93.53-93.55/87.12 percent Persistence line/branch, 95.98/94.00 percent creator-validator line/branch, 94.76/85.13-87.16 percent AgentHost line/branch, 96.40/88.21 percent AgentPlay line/branch, 95.69/95.55 percent AgentViewer line/branch, and 94.56-94.58/87.73-87.78 percent aggregate. Ranges reflect platform-specific generated branches. The wrapper requires Rules, Persistence, AgentPlay, AgentViewer, and AgentHost to appear exactly once, while Coverlet's minimum-module threshold gates every instrumented module. The 0.4 acceptance target remains 90 percent branch coverage. The real Godot scene smoke uses isolated replay storage (1-4 envelopes), mirror-completes terminal death steps, browses and controls verified deterministic playback, and asserts structured log event codes including `run_dead`, `replay_finalized`, `run_start`, and `achievements_load`.
