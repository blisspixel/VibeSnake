...
- One thousand two native xUnit contracts with 90 percent line and 85 percent branch floors per measured module under Coverlet 10. The current local Windows report is 95.80/88.44 percent Rules line/branch, 93.54/87.17 percent Persistence line/branch, 95.98/94.00 percent creator-validator line/branch, 94.57/87.83 percent AgentHost line/branch, 94.37/89.32 percent AgentPlay line/branch, 94.46/87.99 percent AgentViewer line/branch, and 94.42/87.79 percent aggregate. The wrapper requires Rules, Persistence, AgentPlay, AgentViewer, and AgentHost to appear exactly once, while Coverlet's minimum-module threshold gates every instrumented module. The 0.4 acceptance target remains 90 percent branch coverage. The real Godot scene smoke uses isolated replay storage (1-4 envelopes), mirror-completes terminal death steps, browses and controls verified deterministic playback, and asserts structured log event codes including `run_dead`, `replay_finalized`, `run_start`, and `achievements_load`.
- Required AA-03a identity evidence locks eight unique avatar, accent, and station identities, strict catalog lookup and unknown-ID rejection, Passport v2 anonymous defaults, observation profile v2, observation and result v3, viewer frame v5, rejection of legacy and mixed JSON, immutable live identity, station-name ownership shared with broadcast policy, host and plugin 0.5.0, eight tools, seven resources, and generated OKF drift. The real Agent Watch smoke resolves the passport presentation independently of the human selected cosmetic and verifies that human progression remains unchanged.
