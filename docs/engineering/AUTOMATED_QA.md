...
- 1,189 native xUnit contracts with 90 percent line and 85 percent branch floors per measured module under Coverlet 10. The current local Windows report is 95.87/88.37 percent Rules line/branch, 93.27/87.10 percent Persistence line/branch, 95.98/94.00 percent creator-validator line/branch, 94.44/86.80 percent AgentHost line/branch, 92.47/85.51 percent AgentPlay line/branch, 96.41/87.52 percent AgentViewer line/branch, and 94.01/87.17 percent aggregate. The wrapper requires Rules, Persistence, AgentPlay, AgentViewer, and AgentHost to appear exactly once, while Coverlet's minimum-module threshold gates every instrumented module. The 0.4 acceptance target remains 90 percent branch coverage. The real Godot scene smoke uses isolated replay storage (1-4 envelopes), mirror-completes terminal death steps, browses and controls verified deterministic playback, and asserts structured log event codes including `run_dead`, `replay_finalized`, `run_start`, and `achievements_load`.
