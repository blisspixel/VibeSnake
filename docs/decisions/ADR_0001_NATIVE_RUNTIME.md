...
- The native solution builds with warnings as errors and passes 1,289 tests. Under Coverlet 10, the current local Windows aggregate is 94.11 percent line and 87.17 percent branch coverage, with RepositoryChecks at 94.77 percent line and 88.46 percent branch. Current 90 percent line and 85 percent branch floors apply per measured module, with a retained 90 percent branch target for 0.4 acceptance.
