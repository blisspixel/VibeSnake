...
- The native solution builds with warnings as errors and passes 1,449 tests. Under Coverlet 10, the current local Windows aggregate is 93.71 percent line and 86.62 percent branch coverage, with RepositoryChecks at 92.27 percent line and 85.31 percent branch. Current 90 percent line and 85 percent branch floors apply per measured module, with a retained 90 percent branch target for 0.4 acceptance.
