...
- The native solution builds with warnings as errors and passes 963 tests. Under Coverlet 10, aggregate native coverage is 94.41 percent line and 87.71 percent branch, with current 90 percent line and 85 percent branch floors per measured module and a retained 90 percent branch target for 0.4 acceptance.
