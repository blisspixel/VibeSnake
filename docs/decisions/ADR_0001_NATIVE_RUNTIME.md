...
- The native solution builds with warnings as errors and passes 1,465 tests. Under Coverlet 10, the current local Windows aggregate is 93.80 percent line and 86.67 percent branch coverage, with RepositoryChecks at 92.85 percent line and 85.67 percent branch. Current 90 percent line and 85 percent branch floors apply per measured module, with a retained 90 percent branch target for 0.4 acceptance.
