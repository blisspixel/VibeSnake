...
- The native solution builds with warnings as errors and passes 1,388 tests. Under Coverlet 10, the current local Windows aggregate is 94.04 percent line and 87.09 percent branch coverage, with RepositoryChecks at 93.56 percent line and 87.02 percent branch. Current 90 percent line and 85 percent branch floors apply per measured module, with a retained 90 percent branch target for 0.4 acceptance.
