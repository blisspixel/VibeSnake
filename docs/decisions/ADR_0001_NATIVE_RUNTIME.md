...
- The native solution builds with warnings as errors and passes 1,570 tests with zero build warnings. Under Coverlet 10, the current local Windows aggregate is 94.31 percent line and 86.66 percent branch coverage, with RepositoryChecks at 94.63 percent line and 85.92 percent branch. Current 90 percent line and 85 percent branch floors apply per measured module, with a retained 90 percent branch target for 0.4 acceptance.
