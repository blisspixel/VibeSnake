...
- Keep the current catalog-bound Agent Passport ephemeral. Persist a bounded public passport and verified-result history only in the later AA-07 store. Do not persist prompts, chain of thought, credentials, provider responses, or executable policy code.
