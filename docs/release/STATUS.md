...
| Target technology | Qualification in progress | Godot 4.7.1 and .NET 10.0.302 pinned. Pure C# kernel covers core rules plus Shield. Hosted multi-platform player smoke exists. Full feature parity with the Python reference does not. |
