...
public sealed class SnakeRunTests
{
    ...
    public void Canonical_state_has_a_golden_serialization_and_hash()
    {
        var run = CreateRun(
            ...
            direction: Direction.Right,
            food: new GridPoint(4, 3));
        const string expected = """{"schemaVersion":3,"rulesVersion":4,"hashAlgorithm":"fnv1a64-canonical-json-v4","rngAlgorithm":"pcg-xsh-rr-32-v1","config":{"width":5,"height":4,"rulesTickMilliseconds":50,"starvationTicks":100,"maximumDirectionQueue":3,"foodScore":10,"comboWindowTicks":60,"speedBonusTicks":30,"powerSpawnIntervalTicks":300,"powerVisibleTicks":120,"shieldDurationTicks":100,"phaseShiftDurationTicks":100,"lastStandRecoveryTicks":60,"slowMoDurationTicks":120,"boostDurationTicks":80,"magnetDurationTicks":120,"gluttonyDurationTicks":100,"segmentDetachObstacleTicks":200,"segmentDetachMaxSegments":5,"enableNearMiss":true,"enableComboExpiredEvent":true},"tick":0,"status":0,"deathCause":0,"direction":1,"score":0,"comboCount":0,"sessionFoodEaten":0,"sessionWraps":0,"sessionNearMisses":0,"sessionPowerupsCollected":0,"sessionMaxCombo":0,"ticksSinceLastFood":0,"hungerTicksRemaining":100,"powerSpawnTicksElapsed":0,"shieldTicksRemaining":0,"phaseShiftTicksRemaining":0,"lastStandHeld":false,"lastStandRecoveryTicksRemaining":0,"slowMoTicksRemaining":0,"boostTicksRemaining":0,"magnetTicksRemaining":0,"gluttonyTicksRemaining":0,"detachedObstacleTicksRemaining":0,"baitPosition":null,"detachedObstacles":[],"powerPickup":null,"random":{"state":"1","increment":"109"},"food":{"x":4,"y":3},"body":[{"x":1,"y":1}],"pendingDirections":[]}""";

        Assert.Equal(expected, run.SerializeCanonicalState());
        Assert.Equal("e9ef898a6d60ba8d", run.ComputeStateHash());
    }
