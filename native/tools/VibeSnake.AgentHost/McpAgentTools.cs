...
public sealed class McpAgentTools
{
    ...
    [McpServerTool(
        ...
        OutputSchemaType = typeof(StartAgentMatchV4),
        Destructive = false,
        Idempotent = false,
        OpenWorld = false)]
    ...
    public StartAgentMatchV4 StartMatch(
        ...
        [Description("Optional public Agent Passport v3. Avatar, accent, and station IDs must come from vibesnake://agent/identity; the display name is presentation-only; and its observation and action profiles must match the host contract.")] AgentPassportV3? passport = null,
        [Description("Control division: four-direction-step-v1 or four-direction-burst-v1. The default preserves one-step play.")] string actionProfile = AgentPassportV3.FourDirectionActionProfile) =>
    ...
    public StartAgentMatchV4 StartLesson(
        ...
        [Description("Set true to mint a one-time same-user named-pipe capability for a read-only local viewer.")] bool watchEnabled = false,
        [Description("Optional public Agent Passport v3 using avatar, accent, and station IDs from vibesnake://agent/identity. Its observation and action profiles must match the host contract.")] AgentPassportV3? passport = null,
        [Description("Control division: four-direction-step-v1 or four-direction-burst-v1.")] string actionProfile = AgentPassportV3.FourDirectionActionProfile) =>
    ...
    [McpServerTool(
        ...
        UseStructuredContent = true,
        OutputSchemaType = typeof(AgentObservationV4),
        ReadOnly = true,
        Idempotent = true,
        OpenWorld = false)]
    ...
    public AgentObservationV4 ObserveMatch(
    ...
    [McpServerTool(
        ...
        UseStructuredContent = true,
        OutputSchemaType = typeof(AgentActionResponseV4),
        Destructive = false,
        Idempotent = true,
        OpenWorld = false)]
    ...
    [McpServerTool(
        ...
        UseStructuredContent = true,
        OutputSchemaType = typeof(AgentBurstResponseV4),
        Destructive = false,
        Idempotent = true,
        OpenWorld = false)]
    ...
    [McpServerTool(
        ...
        UseStructuredContent = true,
        OutputSchemaType = typeof(AgentMatchSummaryV4),
        Destructive = false,
        Idempotent = true,
        OpenWorld = false)]
    ...
    public AgentMatchSummaryV4 FinishMatch(
        [Description("Opaque handle returned by start_match.")] string matchHandle) =>
    ...
    [McpServerTool(
        ...
        UseStructuredContent = true,
        OutputSchemaType = typeof(AgentMatchResultStatusV4),
        ReadOnly = true,
        Idempotent = true,
        OpenWorld = false)]
    ...
    public AgentMatchResultStatusV4 GetMatchResult(
        [Description("Opaque handle returned by start_match.")] string matchHandle) =>
