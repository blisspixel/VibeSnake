...
- Godot bindings browse/remap screen (`B` / right shoulder): Up/Down select, Confirm captures a key via `TryRemapAction`, Esc cancels; smoke covers open, remap save, and restore defaults.
