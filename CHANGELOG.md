...
- Added a minimal Agent Skill and Agent Plugins 1.0.0 preview package with deterministic validation and checksums, plus a generated Open Knowledge Format 0.2 bundle derived from canonical rules and protocol sources. The formats remain optional interoperability surfaces rather than gameplay authorities.
