...
- Bounded Agent Arena viewer pipe names to a portable 24-character contract with 80 bits of random identity, added a ten-second fail-closed connection deadline, and made malformed-frame tests delivery-aware so macOS socket paths and loaded Windows runners remain reliable.
