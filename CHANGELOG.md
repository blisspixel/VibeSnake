...
- Tightened Agent Arena claims to the implemented preview: passport shed and station values are labels pending closed-catalog avatar rendering; terminal output lists the actual ten-metric vector; rejection responses clear prior events; ordinary replay hashes verify each lane but do not constitute the planned exhibition receipt; and human review remains required before legibility, expression, or drama is claimed as achieved.
