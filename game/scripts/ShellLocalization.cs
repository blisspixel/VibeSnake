...
internal static class ShellLocalization
{
    ...
    [
        ...
        Entry(
            ...
            "{operation}  {delivery}"),
        Entry("agent-arena.operation.initial", "WAITING FOR FIRST ACTION"),
        Entry("agent-arena.operation.step", "STEP +{steps}"),
        Entry(
            "agent-arena.operation.burst",
            "BURST +{steps} | {reason} | {event}"),
        Entry("agent-arena.operation.finish", "FINISH REQUEST"),
        Entry("agent-arena.delivery.continuous", "LIVE FEED CONTINUOUS"),
        Entry(
            "agent-arena.delivery.coalesced",
            "LIVE FEED SKIPPED {count} EARLIER UPDATES"),
        Entry("agent-arena.burst.stop.none", "NO STOP REASON"),
        Entry("agent-arena.burst.stop.requested-limit", "REQUEST LIMIT"),
        Entry("agent-arena.burst.stop.decision-event", "DECISION EVENT"),
        ...
        Entry("agent-arena.burst.event.died", "DEATH"),
        Entry("agent-arena.burst.event.won", "WIN"),
        Entry("agent-arena.burst.event.power-spawned", "POWER SPAWN"),
        Entry("agent-arena.burst.event.power-collected", "POWER COLLECT"),
        Entry("agent-arena.burst.event.power-activated", "POWER ACTIVATE"),
        Entry("agent-arena.burst.event.power-expired", "POWER EXPIRE"),
        Entry("agent-arena.burst.event.power-consumed", "POWER CONSUME"),
        Entry("agent-arena.burst.event.power-discarded", "POWER DISCARD"),
        Entry("agent-arena.burst.event.collision-prevented", "COLLISION PREVENTED"),
        Entry("agent-arena.burst.event.near-miss", "NEAR MISS"),
        Entry("agent-arena.burst.event.starvation-warning", "HUNGER WARNING"),
        Entry("agent-arena.burst.event.combo-expired", "COMBO EXPIRED"),
        Entry("agent-arena.burst.event.achievement-candidate", "ACHIEVEMENT SIGNAL"),
        ...
        Entry("agent-arena.story.highlight.recovery", "RECOVERY"),
        Entry("agent-arena.story.highlight.style-all", "STYLE COMPLETE"),
        Entry("agent-arena.story.highlight.lesson-all", "LESSON COMPLETE"),
        Entry("agent-arena.story.highlight.style-first", "STYLE THRESHOLD"),
        Entry("agent-arena.story.highlight.lesson-first", "LESSON REQUIREMENT"),
        Entry("agent-arena.story.highlight.near-miss", "NEAR MISS"),
        Entry("agent-arena.story.highlight.combo", "COMBO"),
        Entry("agent-arena.story.highlight.power-on", "POWER ON"),
        Entry("agent-arena.story.highlight.power-get", "POWER TAKEN"),
        Entry("agent-arena.story.highlight.hunger", "HUNGER"),
        Entry("agent-arena.story.highlight.trapped", "TRAPPED"),
        Entry("agent-arena.story.highlight.pinned", "PINNED"),
        Entry("agent-arena.story.highlight.intent", "INTENT"),
        Entry("agent-arena.story.highlight.none", "STORY"),
        Entry("agent-arena.story.lane.agent", "AGENT"),
        Entry("agent-arena.story.lane.rival", "RIVAL"),
        Entry("agent-arena.story.lead.ahead", "AHEAD"),
        Entry("agent-arena.story.lead.level", "LEVEL"),
        Entry("agent-arena.story.lead.behind", "BEHIND"),
        Entry("agent-arena.story.lead.none", "SOLO"),
        Entry("agent-arena.story.pace.linger", "LINGER"),
        Entry("agent-arena.story.pace.selected", "BEAT"),
        Entry("agent-arena.story.pace.skip", "SKIP"),
        Entry("agent-arena.story.turning", "TURN {index}/{total}"),
        Entry(
            "agent-arena.story.overlay",
            "{highlight}  |  {lane}  |  {pace}  |  {lead}  |  {turning}"),
        Entry(
            "agent-arena.story.refuse.not-archived",
            "STORY UNAVAILABLE: EXHIBITION IS NOT ARCHIVED"),
        Entry(
            "agent-arena.story.refuse.agent-missing",
            "STORY UNAVAILABLE: THE AGENT REPLAY FILE WAS REMOVED"),
        Entry(
            "agent-arena.story.refuse.rival-missing",
            "STORY UNAVAILABLE: THE RIVAL REPLAY FILE WAS REMOVED"),
        Entry(
            "agent-arena.story.refuse.agent-mismatch",
            "STORY UNAVAILABLE: THE AGENT REPLAY DOES NOT MATCH THE RECEIPT"),
        Entry(
            "agent-arena.story.refuse.rival-mismatch",
            "STORY UNAVAILABLE: THE RIVAL REPLAY DOES NOT MATCH THE RECEIPT"),
        Entry(
            "agent-arena.story.refuse.invalid",
            "STORY UNAVAILABLE: THE RECEIPT IS NOT CANONICAL"),
        Entry("action.turning-previous", "previous turning point"),
        Entry("action.turning-next", "next turning point"),
        ...
        Entry("run.status.running", "RUNNING"),
        Entry("run.status.dead", "DEAD"),
        Entry("run.status.won", "WON"),
        Entry("run.status.paused", "PAUSED"),
        Entry("run.status.paused-focus-lost", "PAUSED: FOCUS LOST"),
...
internal sealed record LocalizationQualificationEvidence(
    ...
    bool AgentViewerOverlayLayoutPassed,
    bool RunHudTitleLayoutPassed,
    bool RunHudRowLayoutPassed,
    int RunHudRowCellCount,
    int RunHudRowMinimumFontSize,
